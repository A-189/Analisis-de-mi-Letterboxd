---
title: "Analisis de mis Likes en Letterboxd"
author: "A-189"
date: "2025-11-13"
...
## Análisis de mis Likes en Letterboxd
...
```
```{r}
ggsave("Output/plot_peliculas_genero.png", width = 8, height = 5)
```
...
```{r}
ggsave("Output/plot_peliculas_tematicas.png", width = 8, height = 6)
```
...
```
```{r}
ggsave("Output/plot_peliculas_nanogenero.png", width = 8, height = 6)
